...
{
    /**
     * Verifies index.json was generated by bootstrap.php during test initialization.
     * This is the first test to run and validates the index generation pipeline works.
     */
    #[ContractTest(
        name: 'Index Generated',
        description: 'Verifies index.json was generated by bootstrap.php during test initialization',
        category: 'smoke',
    )]
    public function testIndexWasGenerated(): void
    {
        $this->assertFileExists(CALLS_JSON_PATH, 'index.json should be generated by bootstrap');
    }

    /**
     * Verifies CallsData wrapper loaded index.json successfully.
     * Checks that both values and calls arrays are non-empty.
     */
    #[ContractTest(
        name: 'Calls Data Loaded',
        description: 'Verifies CallsData wrapper loaded index.json successfully with non-empty values and calls arrays',
        category: 'smoke',
    )]
    ...
    public function testOrderRepositorySaveParameterExists(): void
    {
        ...
        $this->assertNotEmpty(
            ...
            'Reference: src/Repository/InMemoryOrderRepository.php:26'
        );
    ...
    /**
     * Verifies index.json contains a valid semver-like version field.
     * Example: "3.2"
     */
    #[ContractTest(
        name: 'Version Present',
        description: 'Verifies index.json contains a valid semver-like version field (e.g., 3.2)',
        category: 'smoke',
    )]
